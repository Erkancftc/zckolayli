	...
	if($('.mobile-menu').length){
		...
		$('.mobile-nav-toggler').on('click', function() {
			...
			if (!$('.mobile-menu .navigation.clearfix .card-payment').length) {
  			$(".mobile-menu .navigation.clearfix").append('<li class="card-payment"><a href="https://pos.param.com.tr/Tahsilat/Default-v2.aspx?k=EA71D78F-0F4E-4838-A7AD-AD82BB8B6B5E" target="_blank">Online Ödeme</a></li>')
}
		});
